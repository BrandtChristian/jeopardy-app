...
export function QuestionReveal({ category, amount, onDismiss }: QuestionRevealProps) {
  const questionData = getQuestion(category, amount);
    ...
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50">
      <div className="w-[90vw] max-w-6xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xl text-white/80">{amount} point{amount !== 1 ? 's' : ''}</p>
        </div>
